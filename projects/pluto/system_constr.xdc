...
set_property  -dict {PACKAGE_PIN U17  IOSTANDARD LVCMOS18 PULLTYPE PULLUP} [get_ports iic_scl]
set_property  -dict {PACKAGE_PIN Y17  IOSTANDARD LVCMOS18 PULLTYPE PULLUP} [get_ports iic_sda]
...
set_property  -dict {PACKAGE_PIN P16  IOSTANDARD LVCMOS18} [get_ports pl_spi_clk_o]
set_property  -dict {PACKAGE_PIN U19  IOSTANDARD LVCMOS18} [get_ports pl_spi_miso]
set_property  -dict {PACKAGE_PIN V15  IOSTANDARD LVCMOS18} [get_ports pl_spi_mosi]
